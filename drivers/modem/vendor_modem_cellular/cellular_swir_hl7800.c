...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(
	swir_hl7800_configuration_chat_script_cmds,
...
MODEM_CHAT_SCRIPT_DEFINE(swir_hl7800_configuration_chat_script,
			 swir_hl7800_configuration_chat_script_cmds, abort_matches,
...
static const struct modem_cellular_vendor_config hl7800_vendor = {
	...
	.scripts = {
		...
		.configuration = &swir_hl7800_configuration_chat_script,
