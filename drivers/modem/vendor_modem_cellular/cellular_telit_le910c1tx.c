...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(
	telit_le910c1tx_configuration_chat_script_cmds,
...
MODEM_CHAT_SCRIPT_DEFINE(telit_le910c1tx_configuration_chat_script,
			 telit_le910c1tx_configuration_chat_script_cmds, abort_matches,
...
static const struct modem_cellular_vendor_config telit_le910c1tx_vendor = {
	...
	.scripts = {
		...
		.configuration = &telit_le910c1tx_configuration_chat_script,
